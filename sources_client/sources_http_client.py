...
class SourcesHTTPClient:
    ...
    def get_cost_management_application_type_id(self):
        application_type_url = '{}/application_types?filter[name]=/insights/platform/cost-management'.format(self._base_url)
    ...
    def get_aws_role_arn(self):
        ...
        authentications_url = '{}/authentications?filter[resource_type]=Endpoint&[resource_id]={}'.format(self._base_url, str(resource_id))
        ...
        authentications_internal_url = '{}/authentications/{}?expose_encrypted_attribute[]=password'.format(self._internal_url, str(authentications_id))
