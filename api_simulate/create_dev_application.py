...
async def send_one():
    ...
    try:
        # Produce message
        message_contents = "{\"id\":\"16\",\"application_type_id\":\"2\",\"created_at\":\"2019-06-18 18:09:14 UTC\",\"updated_at\":\"2019-06-18 18:09:14 UTC\",\"source_id\":\"1\"}"
        message_headers = [("event_type", b"Application.create"),
